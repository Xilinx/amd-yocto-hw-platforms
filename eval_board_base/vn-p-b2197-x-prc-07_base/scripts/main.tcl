...
set xdc_list {xdc/xcvn3716_lpddr5_tenzing_2_700_701.xdc}
...
create_project -name $proj_name -force -dir $proj_dir/$proj_name -part xcvn3716-vsvb2197-2LHPV-e-S
...
puts $fd "##########################################################################"
puts $fd "This is a brief document containing design specific details for : ${proj_name}"
