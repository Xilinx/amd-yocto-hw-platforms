...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    ...
    CONFIG.PSX_PMCX_CONFIG(PMCX_EMMC) {CD_ENABLE 0 POW_ENABLE 0 WP_ENABLE 0 RESET_ENABLE 1 CD_IO PMCX_MIO_2 POW_IO PMCX_MIO_12 WP_IO PMCX_MIO_1 RESET_IO PMCX_MIO_25 CLK_50_SDR_ITAP_DLY 0x00 CLK_50_SDR_OTAP_DLY\
0x00 CLK_50_DDR_ITAP_DLY 0x00 CLK_50_DDR_OTAP_DLY 0x00 CLK_100_SDR_OTAP_DLY 0x00 CLK_200_SDR_OTAP_DLY 0x00} \
    CONFIG.PSX_PMCX_CONFIG(PMCX_EMMC_DATA_TRANSFER_MODE) {8Bit} \
    CONFIG.PSX_PMCX_CONFIG(PMCX_EMMC_PERIPHERAL) {PRIMARY_ENABLE 0 SECONDARY_ENABLE 1 IO PMCX_MIO_14:25 IO_TYPE MIO} \
    ...
    CONFIG.PSX_PMCX_CONFIG(PMCX_MIO42) {DRIVE_STRENGTH 8mA SLEW slow PULL pullup SCHMITT 0 AUX_IO 0 USAGE GPIO OUTPUT_DATA default DIRECTION in} \
    CONFIG.PSX_PMCX_CONFIG(PMCX_MIO43) {DRIVE_STRENGTH 8mA SLEW slow PULL pullup SCHMITT 0 AUX_IO 0 USAGE GPIO OUTPUT_DATA default DIRECTION in} \
    CONFIG.PSX_PMCX_CONFIG(PMCX_MIO50) {DRIVE_STRENGTH 8mA SLEW slow PULL pullup SCHMITT 0 AUX_IO 0 USAGE GPIO OUTPUT_DATA default DIRECTION in} \
    CONFIG.PSX_PMCX_CONFIG(PMCX_MIO51) {DRIVE_STRENGTH 8mA SLEW slow PULL pullup SCHMITT 0 AUX_IO 0 USAGE GPIO OUTPUT_DATA default DIRECTION in} \
    CONFIG.PSX_PMCX_CONFIG(PMCX_OSPI_ECC_FAIL_IO) {PMCX_MIO_13} \
    CONFIG.PSX_PMCX_CONFIG(PMCX_OSPI_PERIPHERAL) {PRIMARY_ENABLE 1 SECONDARY_ENABLE 0 IO PMCX_MIO_0:13 MODE Dual_Stacked} \
    ...
    CONFIG.PSX_PMCX_CONFIG(PMCX_SDIO_30_PERIPHERAL) {PRIMARY_ENABLE 0 SECONDARY_ENABLE 0 IO PMCX_MIO_13:25 IO_TYPE MIO} \
    CONFIG.PSX_PMCX_CONFIG(PMCX_USE_PMCX_AXI_NOC0) {1} \
    CONFIG.PSX_PMCX_CONFIG(PSX_CAN0_PERIPHERAL) {ENABLE 0 IO PMCX_MIO_8:9 IO_TYPE MIO} \
    CONFIG.PSX_PMCX_CONFIG(PSX_CAN1_PERIPHERAL) {ENABLE 0 IO PSX_MIO_16:17 IO_TYPE MIO} \
    CONFIG.PSX_PMCX_CONFIG(PSX_ENET0_MDIO) {ENABLE 0 IO PMCX_MIO_50:51 IO_TYPE MIO} \
    CONFIG.PSX_PMCX_CONFIG(PSX_ENET0_PERIPHERAL) {ENABLE 0 IO PMCX_MIO_26:37 IO_TYPE MIO MODE RGMII} \
    CONFIG.PSX_PMCX_CONFIG(PSX_ENET1_MDIO) {ENABLE 1 IO PSX_MIO_24:25 IO_TYPE MIO} \
    CONFIG.PSX_PMCX_CONFIG(PSX_ENET1_PERIPHERAL) {ENABLE 1 IO PSX_MIO_12:23 IO_TYPE MIO MODE RMII} \
    ...
    CONFIG.PSX_PMCX_CONFIG(PSX_GEN_IPI1_NOBUF_MASTER) {R52_0} \
    CONFIG.PSX_PMCX_CONFIG(PSX_GEN_IPI2_NOBUF_ENABLE) {1} \
    CONFIG.PSX_PMCX_CONFIG(PSX_GEN_IPI2_NOBUF_MASTER) {R52_1} \
    ...
    CONFIG.PSX_PMCX_CONFIG(PSX_I3C_I2C0_PERIPHERAL) {ENABLE 1 IO PSX_MIO_2:3 IO_TYPE MIO TYPE I3C} \
    CONFIG.PSX_PMCX_CONFIG(PSX_I3C_I2C1_PERIPHERAL) {ENABLE 1 IO PSX_MIO_0:1 IO_TYPE MIO TYPE I3C} \
    CONFIG.PSX_PMCX_CONFIG(PSX_MIO13) {DRIVE_STRENGTH 8mA SLEW slow PULL disable SCHMITT 1 AUX_IO 0 USAGE Reserved OUTPUT_DATA default DIRECTION out} \
    CONFIG.PSX_PMCX_CONFIG(PSX_MIO14) {DRIVE_STRENGTH 8mA SLEW slow PULL disable SCHMITT 1 AUX_IO 0 USAGE Reserved OUTPUT_DATA default DIRECTION out} \
    CONFIG.PSX_PMCX_CONFIG(PSX_MIO17) {DRIVE_STRENGTH 8mA SLEW slow PULL disable SCHMITT 1 AUX_IO 0 USAGE Reserved OUTPUT_DATA default DIRECTION out} \
    CONFIG.PSX_PMCX_CONFIG(PSX_MIO18) {DRIVE_STRENGTH 8mA SLEW slow PULL disable SCHMITT 0 AUX_IO 0 USAGE Reserved OUTPUT_DATA default DIRECTION in} \
    CONFIG.PSX_PMCX_CONFIG(PSX_MIO19) {DRIVE_STRENGTH 8mA SLEW slow PULL disable SCHMITT 0 AUX_IO 0 USAGE Reserved OUTPUT_DATA default DIRECTION in} \
    CONFIG.PSX_PMCX_CONFIG(PSX_MIO20) {DRIVE_STRENGTH 8mA SLEW slow PULL disable SCHMITT 0 AUX_IO 0 USAGE Reserved OUTPUT_DATA default DIRECTION in} \
    CONFIG.PSX_PMCX_CONFIG(PSX_MIO21) {DRIVE_STRENGTH 8mA SLEW slow PULL disable SCHMITT 0 AUX_IO 0 USAGE Reserved OUTPUT_DATA default DIRECTION in} \
    CONFIG.PSX_PMCX_CONFIG(PSX_MIO23) {DRIVE_STRENGTH 8mA SLEW slow PULL disable SCHMITT 0 AUX_IO 0 USAGE Reserved OUTPUT_DATA default DIRECTION in} \
...
IO_TYPE MIO} \
    CONFIG.PSX_PMCX_CONFIG(PSX_SPI1) {GRP_SS0_ENABLE 0 GRP_SS0_IO PSX_MIO_9 GRP_SS1_ENABLE 0 GRP_SS1_IO PSX_MIO_8 GRP_SS2_ENABLE 1 GRP_SS2_IO PMCX_MIO_45 PERIPHERAL_ENABLE 1 PERIPHERAL_IO PMCX_MIO_44:49\
IO_TYPE MIO} \
    ...
    CONFIG.PSX_PMCX_CONFIG(PSX_UART0_PERIPHERAL) {ENABLE 1 IO PSX_MIO_8:9 IO_TYPE MIO} \
    CONFIG.PSX_PMCX_CONFIG(PSX_UART0_RTS_CTS) {ENABLE 1 IO PSX_MIO_10:11 IO_TYPE MIO} \
    CONFIG.PSX_PMCX_CONFIG(PSX_UART1_PERIPHERAL) {ENABLE 1 IO PMCX_MIO_46:47 IO_TYPE MIO} \
