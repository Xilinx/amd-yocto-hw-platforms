...
create_project $proj_name $proj_dir/$proj_name -part xcvh1582-vsva3697-2MP-e-S
...
#since CED does not have initial boot paths enabled, so disabling it, will re-enable after CED support added
