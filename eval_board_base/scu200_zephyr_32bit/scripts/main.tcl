...
create_project $proj_name $proj_dir/$proj_name -part xcsu200p-sbva1024-2-e
set_property board_part xilinx.com:$board:part0:* [current_project]
create_bd_design "microblaze_v_preset" -mode batch
instantiate_example_design -template xilinx.com:design:microblaze_v_preset:* -design microblaze_v_preset -options { Preset.VALUE Real-time_Processor}
