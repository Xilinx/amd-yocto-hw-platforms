...
instantiate_example_design -template xilinx.com:design:versal_gen1_platform:1.1 -design versal_gen1_platform -options { Design_type.VALUE Extensible Include_AIE.VALUE true}
