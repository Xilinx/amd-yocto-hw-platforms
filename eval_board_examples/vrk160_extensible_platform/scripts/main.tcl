...
# vrk160 is an EA (ES1) part in 2026.2 - enable beta devices before creating the
# project (also covered globally by ~/.Xilinx/Vivado/Vivado_init.tcl in this env).
enable_beta_device *
...
# simulation model, not implementation. Mirrors the vrk160_base flow.
