...
set_property PACKAGE_PIN H9 [get_ports {c0_sys_0_clk_p[0]}]
set_property PACKAGE_PIN G9 [get_ports {c0_sys_0_clk_n[0]}]
set_property IOSTANDARD LVDS [get_ports c0_sys_0_clk_*]
